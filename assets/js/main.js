...
const cardA = document.querySelector('#rowAlquiler')
  ...
  <div class="col-md-4 mb-4">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p><i class="fas fa-bed"></i>${propiedad_venta.habitaciones} | <i class="fas fa-bath"></i>${propiedades_venta[1].baños}</p>
...
for (propiedad_alquiler of propiedades_alquiler){
  let cardAlquilerFumar = () => {
  ...
  <div class="col-md-4 mb-4">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p><i class="fas fa-bed"></i>${propiedad_alquiler.habitaciones} | <i class="fas fa-bath"></i>${propiedades_venta[1].baños}</p>
